...
//                 {stationData?.address
//                   ? stationData.address
//                   : stationData?.location?.coordinates?.length >= 2 ? `${stationData.location.coordinates[1]}, ${stationData.location.coordinates[0]}`: "Location not set"}
//               </div>
//               <div className="mt-2">
        ...
        {alerts.length === 0 ? (
          ...
          <div className="row">
            {alerts.map((alert) => (
              ...
              >
                <div
                  className={`card active-alert-card shadow-lg h-100 ${newAlertIds.includes(alert._id) ? "blink-alert" : ""}`}
                  style={{
                    borderColor:
                      alert.riskColor === "red"
                        ? "#ff4d4d"
                ...
                >
                  ...
                  <div className="card-body">
                    ...
                    {selectedAlert?._id === alert._id && showCamera && (
                      <div className="card p-2 mb-2">
                        <div style={{ fontWeight: 700 }} className="mb-1">
                          Live Camera Stream
                        </div>
                        <video controls style={{ width: "100%", borderRadius: 8 }}>
                          <source
        ...
        {showHandledModal && (
          <div className="handled-modal">
            <div className="modal-content p-4">
              <div className="d-flex justify-content-between align-items-center mb-3">
                <h5 className="mb-0">✅ Handled Alerts ({handledAlerts.length})</h5>
                <button className="btn btn-sm btn-outline-secondary" onClick={() => setShowHandledModal(false)}>
                  Close
                </button>
              </div>
              {handledAlerts.length === 0 ? (
                  ...
                  {handledAlerts.map((alert) => (
                    ...
                    >
                      ...
                      <div className="card-body">
                        ...
                        <p>
                          <b>Message:</b> {alert.evidence?.message || "No message"}
                        </p>
                        ...
                        {alert.evidence?.audioUrl && (
                          <div className="mb-3">
                            ...
                            <a
                              href={`${BASE}${alert.evidence.audioUrl}`}
                              download
                              className="btn btn-sm btn-outline-primary mt-2"
                            >
                              <DownloadCloud size={14} className="me-1" /> Download Audio
                        ...
                        <p>
                          <b>Reported:</b> {new Date(alert.createdAt).toLocaleString()}
                        </p>
                        ...
                        >
                          ...
                          <div className="small text-muted">
                            Successfully handled by station
                          </div>
                        </div>
                      </div>
                    </div>
